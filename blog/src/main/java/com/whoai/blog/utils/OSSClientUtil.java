...
import com.whoai.blog.bean.OSSClientConstants;
...
public class OSSClientUtil {
    ...
    //log日志
    private static Logger logger = LoggerFactory.getLogger(OSSClientUtil.class.getName());
    //阿里云API的内或外网域名
    ...
    public static String uploadObject2OSS(OSSClient ossClient, MultipartFile file, String bucketName, String folder, String category) {
        ...
        try {
            ...
            //上传文件   (上传文件流的形式)
            PutObjectResult putResult = ossClient.putObject(bucketName, folder + category + fileName, is, metadata);
            //解析结果
